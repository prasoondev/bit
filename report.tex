...
\hypersetup{
    ...
    urlcolor=cyan,
    citecolor=blue,
    pdftitle={Crisis-Aware Stock Market Prediction},
...
\fancyhf{}
\rhead{\thepage}
\lhead{Crisis-Aware Stock Market Prediction}
...
\begin{titlepage}
    \centering
    \vspace*{2cm}
    {\Huge\bfseries Crisis-Aware Stock Market Prediction:\\[0.3cm]
    A Deep Learning Approach with Regime-Switching Analysis\par}
    \vspace{2cm}
    {by\par}
...
\midrule
1 & 0.0403 & 0.8410 & ✗ \\
\textbf{2} & \textbf{3.1646} & \textbf{0.0423} & \textbf{✓} \\
3 & 2.1281 & 0.0944 & ✗ \\
4 & 1.6023 & 0.1707 & ✗ \\
5 & 1.3340 & 0.2464 & ✗ \\
6 & 1.5572 & 0.1553 & ✗ \\
...
\midrule
\textbf{Model B (Technical)} & \textbf{0.6130} & \textbf{0.6092} & \textbf{🏆} \\
